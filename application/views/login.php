...
<body>
  ...
  <div class="col-md-4 jarak-atas col-md-offset-4">
    ...
    <p class="login-box-msg"><b><center>Please Login First</center></b> </p>
    <?php 
    if($this->session->flashdata('pesan')!=null)
    {
      echo "<div class='alert alert-success'>".$this->session->flashdata('pesan')."</div>";}?>
       <form method="post" action="<?=base_url('index.php/bioskop/proses_login')?>">
   ...
   <center><a href="<?=base_url()?>index.php/bioskop/register" class="text-center">Register a New Membership</a></center> 
  </div>
            </center>
          </div>
        </div>
